...
class AbstractTask(abc.ABC):
    ...
    def sample_datasets(self, datasets):
        ...
        print(f'len shuffled_train: {len(shuffled_train)}')

        print(f'We are now sampling from the dataset, datasets type looks like this...: {datasets}')
        ...
        if self.task in ["mr", "cr", "subj", "SST-2", "trec",  "sst-5",
                         "boolq", "rte", "cb", "wic", "qnli", "qqp", "mrpc", "mfrc"]:
            ...
            for label in range(self.num_labels):
                ...
                print(f'The length of data: {len(data)}, num_smaples: {num_samples}')
